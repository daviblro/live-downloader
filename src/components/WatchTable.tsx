...
export function WatchTable({ targets, selectedId, onSelect, onCheck, onToggle, onRemove }: WatchTableProps) {
  ...
  const formatTime = (value: string | null) => value ? new Intl.DateTimeFormat(localeTag[locale], { hour: "2-digit", minute: "2-digit", month: "short", day: "numeric" }).format(new Date(value)) : "—";
