...
function Overview({ payload, selected, jobs, onAdd, onCheck, onOpenDownloads, onPauseAll, onRemove, onResumeAll, onSelect, onStop, onToggle }: {
  payload: BootstrapPayload; selected: WatchTarget | null; jobs: RecordingJob[]; onAdd: () => void; onCheck: (target: WatchTarget) => void; onOpenDownloads: () => void; onPauseAll: () => void; onRemove: (target: WatchTarget) => void; onResumeAll: () => void; onSelect: (target: WatchTarget) => void; onStop: (jobId: string) => void; onToggle: (target: WatchTarget) => void;
}) {
