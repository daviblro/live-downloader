...
const portugueseBrazil: Translation = {
  ...
  toast: { settingsSaved: "Configurações salvas.", downloadsOpened: "Pasta de downloads aberta.", legacyImported: "Lista de monitoramento legada importada.", monitoringPaused: "Monitoramento pausado e as gravações ativas estão sendo interrompidas.", monitoringResumed: "Monitoramento retomado.", checking: (name) => `Verificando ${name} agora.`, recordingStopping: "A gravação está sendo interrompida.", recordingStopped: "Gravação interrompida na prévia.", recordingStartedBackground: "Uma stream começou a gravar em segundo plano.", removed: (name) => `${name} removida.` },
